...
function NativeJSBBEditor(options) {
    ...
    function modal(props) {
        ...
        var render = function () {
            ...
            button_ok.className = 'button';
            button_ok.innerHTML = mConfig.ApplyButton ? mConfig.ApplyButton : 'OK';
    ...
    function _attachEvents() {
        ...
        if (options.editorOnInitCallback &&
            typeof options.editorOnInitCallback === 'function') {

            options.editorOnInitCallback(_data);
